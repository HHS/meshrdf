            ...
            <div class="row content">
              <div id="main" class="col-md-4 col-sm-4 meshrdf-description">
                ...
                <ul>
                  ...
                  <li>Download all <a href="ftp://ftp.nlm.nih.gov/online/mesh/rdf/mesh.nt.gz">MeSH RDF triples in one file</a>. </li>
                </ul>
              ...
              <div class="col-md-6 col-sm-8">
                ...
                <div class="row meshrdf-resource-item">
                  <div class="col-md-6">
                    <h4><a href="ftp://ftp.nlm.nih.gov/online/mesh/rdf/">Download</a></h4>
                  </div>
                  <div class="col-md-6">
