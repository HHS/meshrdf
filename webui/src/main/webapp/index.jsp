...
<div class="row content">
  <div class="col-md-4 col-sm-4 meshrdf-description">
    <a id="skip" name="skip"></a>
    <p>Medical Subject Headings (MeSH) RDF is a linked data representation of the <a href="https://www.nlm.nih.gov/mesh/">MeSH</a> biomedical vocabulary produced by the National Library of Medicine. MeSH RDF includes a downloadable file in <a href="ftp://ftp.nlm.nih.gov/online/mesh/mesh.nt.gz">RDF N-Triples format</a>,
      a <a href="/mesh/query">SPARQL query editor</a>, a <a href="http://hhs.github.io/meshrdf/sparql-and-uri-requests">SPARQL endpoint (API)</a>, and a RESTful interface for retrieving MeSH data.</p>
