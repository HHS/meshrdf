...
<xsl:template match="/">
  ...
  <xsl:for-each select="QualifierRecordSet/QualifierRecord">
     ...
     <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="QualifierUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text> 
     ...
     <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="QualifierUI"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text> 
     ...
     <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="QualifierUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text> 
     <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:isQualifierType> </xsl:text> 
     <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="@QualifierType"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text> 
     ...
     <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="QualifierName/String"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text> 
     ...
     <xsl:if test="DateEstablished">
       ...
       <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="string-join((DateEstablished/Year,DateEstablished/Month,DateEstablished/Day),'-')"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text>
     </xsl:if>
     ...
     <xsl:if test="TreeNodeAllowedList">
       <xsl:for-each select="TreeNodeAllowedList/TreeNodeAllowed">
         <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="../../QualifierUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text> 
         <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:allowedTreeNode&gt; </xsl:text> 
         <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="."/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text>
       </xsl:for-each>
     </xsl:if>
     ...
     <xsl:for-each select="ConceptList/Concept">
       ...
       ==========================================================
       Description: A concept can have a semantic type UI and semantic type name. However, I abstracted this relation into the formulation stated in the
       output above. In this formulation, the concept has a semantic type which in turn has a UI and name.
       ======================================================================================================
       Need to address: N/A.
       -->
       ...
       <xsl:for-each select="TermList/Term">
         ...
         <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="TermUI"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> .&#10;</xsl:text>
  ...
  </xsl:for-each><!-- QualifierRecordSet/QualifierRecord -->
