...
<xsl:template match="/">
  ...
  <xsl:if test="SupplementalRecordSet/SupplementalRecord">
    ...
    <xsl:for-each select="SupplementalRecordSet/SupplementalRecord">
      ...
      <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="SupplementalRecordUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text> 
      <xsl:text disable-output-escaping="yes">&lt;http://purl.org/dc/terms/identifier&gt; </xsl:text> 
      <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="SupplementalRecordUI"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text> 
      ...
      <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="SupplementalRecordUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text>
      <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:SCRClass&gt; </xsl:text>
      <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="@SCRClass"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text>
      ...
      <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:SupplementaryConceptRecord&gt; .&#10;</xsl:text> 
      ...
      <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="SupplementalRecordName/String"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text> 
      ...
      <xsl:if test="DateRevised">
        ...
        <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="string-join((DateRevised/Year,DateRevised/Month,DateRevised/Day),'-')"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text>
      </xsl:if>
      ...
      <xsl:if test="Note">
        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="SupplementalRecordUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text> 
        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:note> </xsl:text> 
      ...
      <xsl:if test ="Frequency">
        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="SupplementalRecordUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text> 
        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:frequency> </xsl:text> 
        <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="Frequency"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text>
      </xsl:if>
      ...
      <xsl:if test="PreviousIndexingList">
        <xsl:for-each select="PreviousIndexingList/PreviousIndexing">
          ...
          <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="replace(normalize-space(.), '\\', '\\\\')"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text>
        </xsl:for-each>
      </xsl:if>
      ...
      <xsl:for-each select="HeadingMappedToList/HeadingMappedTo">
        ...
        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text> 
        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:mappedData&gt; </xsl:text>
        <xsl:text disable-output-escaping="yes">_:blank_set1_</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/>_<xsl:value-of select="position()"/><xsl:text disable-output-escaping="yes"> .&#10;</xsl:text>
	...
	<xsl:text disable-output-escaping="yes">_:blank_set1_</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/>_<xsl:value-of select="position()"/><xsl:text disable-output-escaping="yes"> </xsl:text>
	<xsl:text disable-output-escaping="yes">&lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#type&gt; </xsl:text> 
      	<xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:MappedData&gt; .&#10;</xsl:text> 
        ...
        <xsl:text disable-output-escaping="yes">_:blank_set1_</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/>_<xsl:value-of select="position()"/><xsl:text disable-output-escaping="yes"> </xsl:text>
        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:isMappedToDescriptor&gt; </xsl:text>
        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="replace(DescriptorReferredTo/DescriptorUI,'\*','')"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> .&#10;</xsl:text>
	...
	<xsl:variable name="descui" select="DescriptorReferredTo/DescriptorUI"/>
		...
		<xsl:text disable-output-escaping="yes">_:blank_set1_</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/>_<xsl:value-of select="position()"/><xsl:text disable-output-escaping="yes"> </xsl:text>
	        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:isDescriptorStarred&gt; </xsl:text>
	  ...
	  <!-- added by rw
          ...
          -->
        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="replace(DescriptorReferredTo/DescriptorUI,'\*','')"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> </xsl:text>
          <xsl:text disable-output-escaping="yes">&lt;http://www.w3.org/2000/01/rdf-schema#label&gt; </xsl:text>
          <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="DescriptorReferredTo/DescriptorName/String"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text>
        ...
        <xsl:if test="QualifierReferredTo">
          ...
          <xsl:text disable-output-escaping="yes">_:blank_set1_</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/>_<xsl:value-of select="position()"/><xsl:text disable-output-escaping="yes"> </xsl:text>
          <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:isMappedToQualifier&gt; </xsl:text>
          <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="replace(QualifierReferredTo/QualifierUI,'\*','')"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> .&#10;</xsl:text>
	...
	<xsl:variable name="qualui" select="QualifierReferredTo/QualifierUI"/>
		...
		<xsl:text disable-output-escaping="yes">_:blank_set1_</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/>_<xsl:value-of select="position()"/><xsl:text disable-output-escaping="yes"> </xsl:text>
	        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:isQualifierStarred&gt; </xsl:text>
        	<xsl:text disable-output-escaping="yes">"Y"</xsl:text><xsl:text disable-output-escaping="yes"> .&#10;</xsl:text>
        </xsl:if>
 	...
 	<!-- added by rw
          ...
          -->
            <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="replace(QualifierReferredTo/QualifierUI,'\*','')"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> </xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;http://www.w3.org/2000/01/rdf-schema#label&gt; </xsl:text>
      ...
      </xsl:for-each><!-- HeadingMappedToList/HeadingMappedT -->
      ...
      <xsl:if test="IndexingInformationList">
        <xsl:for-each select="IndexingInformationList/IndexingInformation">
          ...
          <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text> 
          <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:indexingData&gt; </xsl:text>
          <xsl:text disable-output-escaping="yes">_:blank_set2_</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/>_<xsl:value-of select="position()"/><xsl:text disable-output-escaping="yes"> .&#10;</xsl:text>
	...
	<xsl:text disable-output-escaping="yes">_:blank_set2_</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/>_<xsl:value-of select="position()"/><xsl:text disable-output-escaping="yes"> </xsl:text>
	<xsl:text disable-output-escaping="yes">&lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#type&gt; </xsl:text> 
      	<xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:IndexingData&gt; .&#10;</xsl:text> 
          ...
          <xsl:text disable-output-escaping="yes">_:blank_set2_</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/>_<xsl:value-of select="position()"/><xsl:text disable-output-escaping="yes"> </xsl:text>
          <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:indexingDescriptor&gt; </xsl:text>
          <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="DescriptorReferredTo/DescriptorUI"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> .&#10;</xsl:text>
	...
	<!--
      	...
      	-->
	<xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="DescriptorReferredTo/DescriptorUI"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> </xsl:text>
	<xsl:text disable-output-escaping="yes">&lt;http://www.w3.org/1999/02/22-rdf-syntax-ns#type&gt; </xsl:text> 
          ...
          <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="DescriptorReferredTo/DescriptorUI"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> </xsl:text>
          <xsl:text disable-output-escaping="yes">&lt;http://purl.org/dc/terms/identifier&gt; </xsl:text>
          <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="DescriptorReferredTo/DescriptorUI"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text>
          ...
          <xsl:if test="QualifierReferredTo">
            ...
            <xsl:text disable-output-escaping="yes">_:blank_set2_</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/>_<xsl:value-of select="position()"/><xsl:text disable-output-escaping="yes"> </xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:indexingQualifier&gt; </xsl:text>
            <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="QualifierReferredTo/QualifierUI"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> .&#10;</xsl:text>
        ...
        </xsl:for-each><!-- IndexingInformationList/IndexingInformation -->
      </xsl:if>
      ...
      <xsl:if test="SourceList">
        <xsl:for-each select="SourceList/Source">
          ...
          <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="../../SupplementalRecordUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text> 
          <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:source&gt; </xsl:text>
          <xsl:text disable-output-escaping="yes">"</xsl:text><xsl:value-of select="normalize-space(.)"/><xsl:text disable-output-escaping="yes">" .&#10;</xsl:text>
        </xsl:for-each>
      </xsl:if>
      ...
      <xsl:for-each select="ConceptList/Concept">
        ...
        <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="ConceptUI"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> .&#10;</xsl:text>
       ...
       <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:Concept&gt; .&#10;</xsl:text> 
        ...
        ================================================
        Additional: A concept can have a UMLS unique identifier.
        -->
	    ...
	    <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="SemanticTypeUI"/><xsl:text disable-output-escaping="yes">&gt; </xsl:text>
            ...
            <xsl:text disable-output-escaping="yes">&lt;http://nlm.nih.gov#MeSH:</xsl:text><xsl:value-of select="SemanticTypeUI"/><xsl:text disable-output-escaping="yes">&gt;</xsl:text><xsl:text disable-output-escaping="yes"> .&#10;</xsl:text>
    ...
    </xsl:for-each><!-- SupplementalRecordSet/SupplementalRecord -->
  </xsl:if>
